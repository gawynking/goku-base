...
public class JavaSparkTransformationOperation {
    ...
    public static void distinct() {
        ...
        // 构造集合
        List<String> lineList1 = Arrays.asList("hello you", "hello me", "hello world", "chavin king", "hello you", "hello me", "hello world", "chavin king");

        JavaRDD<String> list1rdd = sc.parallelize(lineList1);

        JavaRDD<String> distinctrdd = list1rdd.distinct();
    ...
    public static void intersection() {
        ...
        // 构造集合
        List<String> lineList1 = Arrays.asList("hello you", "hello me", "hello world", "chavin king");
        List<String> lineList2 = Arrays.asList("hello you", "hello me", "hello world", "chavin wang");

        JavaRDD<String> list1rdd = sc.parallelize(lineList1);
        JavaRDD<String> list2rdd = sc.parallelize(lineList2);

        JavaRDD<String> listunionrdd = list1rdd.intersection(list2rdd);

        listunionrdd.foreach(new VoidFunction<String>() {
    ...
    /**
     * 返回一个新的 dataset，它包含了 source dataset（源数据集）和 otherDataset（其它数据集）的并集。
     */
    public static void union() {
        ...
        JavaRDD<String> listunionrdd = list1rdd.union(list2rdd);
    ...
    private static void cogroup() {
        ...
        JavaPairRDD<Integer, Tuple2<Iterable<String>, Iterable<Integer>>> studentScoresRDD = students.cogroup(scores);

        // 打印studnetScores RDD
        studentScoresRDD.foreach(
