...
//        props.put("metadata.broker.list", "chavin.king:9092");
...
//        String action = "view";
//
//        return buffer.append(date).append(" ").append(timestamp).append(" ").append(userid).append(" ").append(pageid)
//                .append(" ").append(section).append(" ").append(action).toString();
//    }
//
