...
import com.gawyn.function.RoaringBitmapUVFunction;
...
//        redisBitmapUVDemoFromUpsertKafka();
        ...
        roaringBitmapUVDemo();
//        roaringBitmapUVDemoFromUpsertKafka();
    }
    ...
    public static void roaringBitmapUVDemo(){
        StreamExecutionEnvironment executionEnvironment = StreamExecutionEnvironment.getExecutionEnvironment();
        StreamTableEnvironment tableEnvironment = StreamTableEnvironment.create(executionEnvironment);
        executionEnvironment.setParallelism(1);
        tableEnvironment.getConfig().set("table.exec.source.idle-timeout","3s");
        ...
        // 注册UDAF
        tableEnvironment.createTemporarySystemFunction("rb_uv_set", RoaringBitmapUVFunction.class);
        ...
        tableEnvironment.executeSql("select \n" +
                "    shop_id,\n" +
                "    rb_uv_set(cast(user_id as int)) as shop_user_cnt\n" +
                "from tbl_order_source \n" +
                "group by \n" +
                "    shop_id\n" +
                ";").print();
    ...
    public static void roaringBitmapUVDemoFromUpsertKafka(){
        StreamExecutionEnvironment executionEnvironment = StreamExecutionEnvironment.getExecutionEnvironment();
        StreamTableEnvironment tableEnvironment = StreamTableEnvironment.create(executionEnvironment);
        executionEnvironment.setParallelism(1);
        tableEnvironment.getConfig().set("table.exec.source.idle-timeout","3s");
