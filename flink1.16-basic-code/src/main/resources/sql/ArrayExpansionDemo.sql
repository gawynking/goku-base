...
create table tbl_order_source(
    ...
    order_tag           array<string>   comment '订单标签集合',
...
select
    ...
    order_tag,
    tag
from tbl_order_upsert cross join unnest(order_tag) as t(tag)
;


{"order_id":"1","order_tag":["a","b","c","d","e"],"shop_id":"2","user_id":"2","original_price":"10","actual_price":"10","discount_price":"0","order_status":"1","create_time":"2024-03-14 20:00:00"}
