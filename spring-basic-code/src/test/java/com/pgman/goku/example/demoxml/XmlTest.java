package com.pgman.goku.example.demoxml;
...
@ContextConfiguration(locations = "classpath:example_xml_bean.xml")
public class XmlTest {
    ...
    public void testUpdateEmp(){
        ...
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("example_xml_bean.xml");
